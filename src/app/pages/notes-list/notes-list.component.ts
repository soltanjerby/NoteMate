  ...
  animations: [
    trigger('itemAnim', [
      ...
      transition('* => void', [
        ...
        // then scale down back to normale siz while beginning to fade out
        animate(50, style({
          transform: 'scale(1)',
          opacity: 0.75
        })),
        ...
        // then animate the spacing (which includes height, margin adn padding)
...
export class NotesListComponent implements OnInit {
  ...
  removeDuplicates(arr: Array<any>) : Array<any> {
    ...
    // look for the input array and add the items to the set
